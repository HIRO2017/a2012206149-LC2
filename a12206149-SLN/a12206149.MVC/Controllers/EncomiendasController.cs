...
namespace a12206149.MVC.Controllers
{
    public class EncomiendasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "encomiendaId,tipoEncomienda,destinoEncomienda")] Encomienda encomienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "encomiendaId,tipoEncomienda,destinoEncomienda")] Encomienda encomienda)
        {
            if (ModelState.IsValid)
            {
