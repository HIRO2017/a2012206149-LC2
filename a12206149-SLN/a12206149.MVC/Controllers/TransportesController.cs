...
namespace a12206149.MVC.Controllers
{
    public class TransportesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "transporteId,nombreTransporte,descripcionTransporte")] Transporte transporte)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "transporteId,nombreTransporte,descripcionTransporte")] Transporte transporte)
        {
            if (ModelState.IsValid)
            {
